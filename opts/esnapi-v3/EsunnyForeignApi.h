...
namespace ESForeign
{
    ...
    public:
		...
		/// \return   void __cdecl
		////////////////////////////////////////
		virtual void __cdecl OnRtnContact(const TContactInfoType *rsp, TEsIsLastType islast, int errCode) = 0;
		...
		/// \return   void __cdecl
		////////////////////////////////////////
		virtual void __cdecl OnRspRequestVertificateCode(const TEsRequestVertificateCodeRsp *rsp, int errCode,const int iReqID) = 0;
    ...
    public:
		...
		/// \return   int __cdecl
		////////////////////////////////////////
		virtual int __cdecl RequestVertificateCode(const TEsRequestVertificateCodeReq CertificateCode, int& iReqID) = 0;
